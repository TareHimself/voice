...
#         "question-answering", model=path.join(getcwd(), "qa_model", "checkpoint-500"))
#     user_info = input("say someting: ")
#     print(question_answerer(question=user_info, context=context))
#     context += user_info + " "
